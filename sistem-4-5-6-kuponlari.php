...
$site['title'] = "Sistem 4-5-6 Kuponları {$dayTitle} - Sistem 4-5-6 İddaa Kuponu";

$site['description'] = "";
$site['url_path'] = "/sistem-4-5-6-kuponlari";
$site['table_title'] = "SİSTEM 4-5-6 KUPONLARI";

$result = getCoupon(SISTEM_4_5_6_KUPON);
...
foreach ($result as $row) {
	...
	if (count($row["coupon_games"]) < 6) continue;
